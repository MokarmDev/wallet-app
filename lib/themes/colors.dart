...
class MyColor {
  static Color primaryColor = const Color(0xff5B259F);
  static Color secondaryColor = const Color(0xff130138);
  ...
  static Color styleTextFieldColor = const Color(0xff828282);
}
